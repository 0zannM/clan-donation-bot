    ...
    if (name === "get_avatar" && fnResult.success && fnResult.base64) {
      ...
      contents.push({
        ...
        parts: [
          ...
          { text: "Bu Wolvesville avatar görselini kısaca betimleyerek yorumla, tarzı beğendiysen öv. En fazla 3 cümle olsun kısa tut. Eğer skin siyahi değil ise bu klana uygun bir skin olmadığını belirt ve yorumlama, 'bu skin ne alaka' gibi eğlenceli bir yorum yap." }
        ]
      });
    } else {
      contents.push({
