...
async function askGemini(userMessage, recentMessages = [], senderPlayerId = null) {
  ...
  const apiConfig = {
    tools: TOOLS,
    generationConfig: { maxOutputTokens: 2000, temperature: 1.8 }
  };
